...
class TurtleNavigationNode(Node):
    ...
    def __init__(self):
        ...
        self.odom_listener = self.create_subscription(
            Odometry, "/odom_pose",self.odom_callback,10)
        ...
        qq = tf_transformations.quaternion_from_euler(0,0,0)#x,y,z or roll, pitch,yawn
        ...
        qq = tf_transformations.quaternion_from_euler(0,0,1.57)#x,y,z or roll, pitch,yawn
